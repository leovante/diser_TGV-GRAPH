...
public class mxEdgeStyle
{
	...
	public static mxEdgeStyleFunction EntityRelation = new mxEdgeStyleFunction()
	{
		...
		/* (non-Javadoc)
		 * @see com.com.mxgraph.view.mxEdgeStyle.mxEdgeStyleFunction#apply(com.com.mxgraph.view.mxCellState, com.com.mxgraph.view.mxCellState, com.com.mxgraph.view.mxCellState, java.util.List, java.util.List)
		 */
