...
public class mxPerimeter
{
	...
	public static mxPerimeterFunction RectanglePerimeter = new mxPerimeterFunction()
	{
		...
		/* (non-Javadoc)
		 * @see com.com.mxgraph.view.mxPerimeter.mxPerimeterFunction#apply
		 */
	...
	public static mxPerimeterFunction TrianglePerimeter = new mxPerimeterFunction()
	{
		...
		/* (non-Javadoc)
		 * @see com.com.mxgraph.view.mxPerimeter.mxPerimeterFunction#apply(com.com.mxgraph.utils.mxRectangle, com.com.mxgraph.view.mxCellState, com.com.mxgraph.view.mxCellState, boolean, com.com.mxgraph.utils.mxPoint)
		 */
		public mxPoint apply(mxRectangle bounds, mxCellState vertex,
				mxPoint next, boolean orthogonal)
		{
